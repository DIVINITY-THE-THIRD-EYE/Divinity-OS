  ...
  useEffect(() => {
    ...
    const start = async () => {
      ...
      try {
        ...
        // Smooth scroll is a progressive enhancement — if a chunk fails to
        // load, native scrolling/anchors still work. Don't leak a rejection.
        console.warn("[SmoothScroll] enhancement skipped:", err);
      }
    };
