...
|---|---|---|
| Web | Lighthouse desktop/mobile, Core Web Vitals | [design/phase0 reports](../divinity-third-eye/divinity/design/phase0/) |
...
2. **Accessible floor** — keyboard focus, `prefers-reduced-motion`, WCAG AA target. ([accessibility-audit](../divinity-third-eye/divinity/design/09-accessibility-audit.md))
