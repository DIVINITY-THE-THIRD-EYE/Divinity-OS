...
-- Insert a batch with capacity 2
insert into public.batches (id, name, schedule_time, capacity, status)
values ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Limited Yoga Batch', '08:00', 2, 'ACTIVE');
