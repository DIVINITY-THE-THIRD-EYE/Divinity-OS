      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Issued ${cert.issuedOnLabel}  ·  ${cert.code}',
            ...
            child: Column(
              children: [
                const Icon(Icons.workspace_premium,
                    size: 56, color: AppColors.accentViolet),
                const SizedBox(height: 16),
                Text('DIVINITY — THE THIRD EYE',
                    style: tt.labelLarge
                ...
                const SizedBox(height: 12),
                Text('is proudly awarded for completing',
